<%-- 
    Document   : inter2
    Created on : 19 nov. 2017, 22:32:23
    Author     : f
--%>
    ...
    <body>
      ...
      -->
       ...
       <section class="tables">
        ...
        %>
                    <tr align="center">
                    <td><%= rs.getInt("id_util")%></td>                    
                    <td><%= rs.getString("nom_util")%></td>
                    <td><%= rs.getString("prenom_util")%></td>
                    <td><%= rs.getString("num_util")%></td>
                    <td><%= rs.getString("email_util")%></td>
                    <td><%= rs.getString("adresse_util")%></td>
                    <td><%= rs.getString("date_util")%></td>
