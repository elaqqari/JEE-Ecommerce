      ...
      -->
        ...
        <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="inter4.jsp">Gestion des supermarchés</a></li>
        ...
        <center>
         <h3>Veuillez entrer le nom du Supermarché :</h3><br>
        <form method="post" action="DelSuper.jsp">
            <input type="text" name="nom_mar" value=""/>
