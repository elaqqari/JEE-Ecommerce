      ...
      -->
        ...
        <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Gestion des supermarchés</li>
            </ul>
        </div>
          <center>
        ...
        <div class="col-sm-6">
            <center>
                <p>Ajouter un nouveau supermarché ?</p><br>
        
            <a href="infoSuper.jsp" class="test">ADD</a>
        </center>    
        </div>
        <div class="col-sm-6 text-right">
            <center>
                <p>Supprimer un supermarché ?</p><br>
            
            <a href="idSupp3.jsp" class="test">DEL</a>
            </center>
            </div>
        </div>
      </div>
