<%-- 
    Document   : modPrix
    Created on : 8 déc. 2017, 20:45:19
    Author     : f
--%>
    ...
    <body>
        ...
        <section id="main-content">
          <section class="wrapper">
              ...
              <center>
        <h2>Veuillez entrer la réference du produit que vous voulez modifier son prix !</h2>
        <table>
            <form action="UpdateProduit" method="post">
                    ...
                    <tr>
                         <td>Nouveau prix de produit </td>
                         <td><input type="number" name="prix" value="" step="any"/></td><td><input type="hidden" name="type" value="<%session.getAttribute("type_enligne");%>"/></td>
                    </tr>
                    <tr>
