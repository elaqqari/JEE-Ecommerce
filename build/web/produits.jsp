<%-- 
    Document   : produits
    Created on : 29 janv. 2018, 14:55:49
    Author     : f
--%>
    ...
    if ((session.getAttribute("login") == null) || (session.getAttribute("login") == "")) {
		...
		<div class="container">
			...
			<div class="w3l_banner_nav_right_banner3">
				<h3>Meilleures offres pour les produits<span class="blink_me"></span></h3>
			</div>
			<div class="w3l_banner_nav_right_banner3_btm">
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							<h4>Easy Buying</h4>
							<p>Vous trouverez tout ce que vous avez des prix raisonnables.</p>
						</div>
					</div>
					<h4>Ustensiles</h4>
                                        <%try{
					...
					<ol><%
                                            ResultSet rs1;
                                            rs1 = st1.executeQuery("select nom_prod from produit,stock where stock.ref_prod=produit.ref_prod and type_prod='Ustensiles' group by nom_prod order by RAND() limit 3 ");
                                            while(rs1.next()){
                                        %>
                                        <li><%=rs1.getString("nom_prod")%></li>
                                        <%}%>
				...
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					...
					<h4>Soin des cheveux</h4>
					<ol><%
                                            ResultSet rs2;
                                            rs2 = st2.executeQuery("select nom_prod from produit,stock where stock.ref_prod=produit.ref_prod and type_prod='Soin de cheveux' group by nom_prod order by RAND() limit 3 ");
                                            while(rs2.next()){
                                        %>
                                        <li><%=rs2.getString("nom_prod")%></li>
                                        <%}%>
				...
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					...
					<h4>Biscuits</h4>
                                        <ol><%
                                            ResultSet rs3;
                                            rs3 = st3.executeQuery("select nom_prod from produit,stock where stock.ref_prod=produit.ref_prod and type_prod='Biscuit' group by nom_prod order by RAND() limit 3 ");
                                            while(rs3.next()){
                                        %>
                                        <li><%=rs3.getString("nom_prod")%></li>
