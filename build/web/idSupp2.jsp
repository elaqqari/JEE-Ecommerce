<%-- 
    Document   : idSupp2
    Created on : 25 nov. 2017, 19:04:21
    Author     : f
--%>
      ...
      -->
        ...
        <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="inter3.jsp">Gestion des livreurs</a></li>
       ...
       <section class="tables">
        <div class="col-lg-6">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Liste des livreurs</h3>
                    </div>
                    <div class="card-body">
        ...
        %>
                    ...
                    <td><%= rs.getString("nom_liv")%></td>
                    <td><%= rs.getString("prenom_liv")%></td>
                    <td><%= rs.getString("num_liv")%></td>
                    <td><%= rs.getString("email_liv")%></td>
        ...
        <center>
         <h3>Veuillez entrer le id du livreur :</h3><br>
        <form method="post" action="DelLiv.jsp">
