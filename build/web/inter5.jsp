<%-- 
    Document   : inter5
    Created on : 30 janv. 2018, 10:25:42
    Author     : f
--%>
       ...
       <section class="tables">
        <div class="col-lg-6">
                    ...
                    <div class="card-body">
                      <table class="table table-striped table-sm">
                        <thead>
                          <tr>
                          <tr align="center"></tr>
                            <th width="8%">id commande</th>
                            <th width="8%">id utilisateur</th>
                            <th width="12%">Nom d'utilisateur</th>
                            <th width="12%">Prenom d'utilisateur</th>
                            <th width="30%">Adresse d'utilisateur</th>
                            <th width="5%">id lvreur</th>
            ...
            try{
                ...
                String sql="select id_com,commande.id_util,nom_util, prenom_util, adresse_util, date_com, total, id_liv from commande,utilisateur where commande.id_util=utilisateur.id_util";
        ...
        %>
                    <tr align="center">
                    <td><%= rs.getInt("id_com")%></td>                    
                    <td><%= rs.getInt("commande.id_util")%></td>
                    <td><%= rs.getString("nom_util")%></td>
                    <td><%= rs.getString("prenom_util")%></td>
                    <td><%= rs.getString("adresse_util")%></td>
                    <td><%= rs.getInt("id_liv")%></td>
                    
                    <td><%= rs.getString("date_com")%></td>
                    <td><%= rs.getFloat("total")%> Dh</td>
        ...
        <center>
         <h3>Veuillez entrer le id de la commande pour la supprimer:</h3><br>
        <form method="post" action="DelCom.jsp">
