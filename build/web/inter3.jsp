<%-- 
    Document   : inter3
    Created on : 25 nov. 2017, 18:53:14
    Author     : f
--%>
...
<html>
    ...
    <body>
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li> <a href="inter4.jsp"> <i class="icon-interface-windows"></i>Gérer les supermarchés</a></li>
      ...
      -->
        ...
        <div class="col-sm-6">
            <center>
                <p>Ajouter un nouveau livreur ?</p><br>
        
            <a href="infoLiv.jsp" class="test">ADD</a>
        </center>    
        </div>
        <div class="col-sm-6 text-right">
            <center>
                <p>Supprimer un livreur ?</p><br>
            
            <a href="idSupp2.jsp" class="test">DEL</a>
            </center>
            </div>
        </div>
      </div>
