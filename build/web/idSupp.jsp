<%-- 
    Document   : idSupp
    Created on : 25 nov. 2017, 15:12:30
    Author     : f
--%>
...
<html>
    ...
    <title>Suppression des responsables</title>
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="#dashvariants" aria-expanded="false" data-toggle="collapse"> <i class="icon-grid"></i> Les Tables</a>
              <ul id="dashvariants" class="collapse list-unstyled">
                  <li><a href="ListSuper.jsp">Supermarchés</a></li>
      ...
      -->
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Suppresion</h2>
            </div>
          </header>
        <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              <li class="breadcrumb-item"><a href="admin.jsp">Home</a></li>
              <li class="breadcrumb-item"><a href="inter1.jsp">Gestion des responsables</a></li>
       ...
       <section class="tables">
        <div class="col-lg-6">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Liste des Responsables</h3>
                    </div>
                    <div class="card-body">
            ...
            <th width="15%">Nom supermarché</th>
        ...
        %>
                    <tr align="center">
                    <td><%= rs.getInt("id_resp")%></td>
                    <td><%= rs.getString("nom_resp")%></td>
                    <td><%= rs.getString("prenom_resp")%></td>
                    <td><%= rs.getString("num_resp")%></td>
                    <td><%= rs.getString("email_resp")%></td>
        ...
        <center>
         <h3>Veuillez entrer le id du responsable :</h3><br>
        <form method="post" action="DelResp.jsp">
